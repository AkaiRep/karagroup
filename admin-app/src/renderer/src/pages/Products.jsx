...
export default function Products() {
  ...
  return (
    <div className="p-6">
      ...
      {/* Global discount */}
      <div className="bg-[#1a1f2e] border border-slate-700/50 rounded-xl p-4 mb-5">
          ...
          <form onSubmit={handleSaveGlobal} className="flex items-center gap-2">
            <div className="relative">
              <input
                ...
                max="100"
                step="0.1"
                className="w-24 bg-[#0f1117] border border-slate-700 rounded-lg px-3 py-2 text-sm text-white focus:outline-none focus:border-brand-500 pr-7"
      ...
      {/* Category form */}
      {showCatForm && (
        <div className="bg-[#1a1f2e] border border-slate-700/50 rounded-xl p-4 mb-4">
      ...
      <div className="flex flex-wrap gap-2 mb-5">
        <button
          ...
          className={`px-3 py-1.5 rounded-lg text-sm font-medium transition-colors ${
            selectedCat === null ? 'bg-brand-500 text-white' : 'bg-[#1a1f2e] text-slate-400 hover:text-white'
          }`}
        >
          Все ({products.length})
        </button>
          ...
          <div key={c.id} className="flex items-center gap-0.5">
            <button
              ...
              className={`px-3 py-1.5 rounded-l-lg text-sm font-medium transition-colors ${
                selectedCat === c.id ? 'bg-brand-500 text-white' : 'bg-[#1a1f2e] text-slate-400 hover:text-white'
              }`}
            >
            ...
            <button
              ...
              className={`px-2 py-1.5 text-xs transition-colors ${
                selectedCat === c.id ? 'bg-brand-600 text-white' : 'bg-[#1a1f2e] text-slate-500 hover:text-slate-300'
              }`}
              title="Переименовать"
            >
              ✎
            ...
            <button
              ...
              className={`px-2 py-1.5 rounded-r-lg text-xs transition-colors ${
                selectedCat === c.id ? 'bg-brand-600 text-white hover:bg-red-500' : 'bg-[#1a1f2e] text-slate-500 hover:text-red-400'
              }`}
        ...
        {uncategorized > 0 && (
          <button
            ...
            className={`px-3 py-1.5 rounded-lg text-sm font-medium transition-colors ${
              selectedCat === 'none' ? 'bg-brand-500 text-white' : 'bg-[#1a1f2e] text-slate-400 hover:text-white'
            }`}
          >
