    ...
    <div className="p-6">
      ...
      <div className="mb-4 flex gap-3">
        <select
          ...
          className="bg-surface border border-border rounded-lg px-3 py-2 text-sm text-slate-300 focus:outline-none focus:border-brand-500"
        >
        ...
        <table className="w-full text-sm">
          ...
          <tbody>
            {loading ? (
              ...
              <tr key={tx.id} className="border-b border-border/30 hover:bg-slate-700/10">
