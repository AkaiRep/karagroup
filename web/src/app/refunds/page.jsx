  ...
  return (
    <LegalPage title="Условия возврата средств">
      ...
      <Section title="Условия возврата">
        ...
        <p><strong className="text-white">Если услуга выполнена ненадлежащим образом</strong> — полный возврат по результату рассмотрения обращения.</p>
      </Section>
      ...
      <Section title="Сроки рассмотрения заявки">
        ...
        <p>В сложных случаях (оспариваемое качество выполнения) срок рассмотрения может быть продлён до <strong className="text-white">7 рабочих дней</strong> — в этом случае мы уведомим вас отдельно.</p>
      </Section>
